...
| FR-07 | Adaptive Categorization | จดจำการแก้หมวดหมู่ของผู้ใช้จากชื่อร้าน/คำค้น และนำไปช่วยจัดหมวดหมู่สลิปถัดไป | Should-Have |
...
- เมื่อผู้ใช้เปลี่ยนหมวดหมู่ ระบบควรบันทึก mapping ของคำค้น/ชื่อร้านแยกตามผู้ใช้ เพื่อนำไปใช้เป็นคำแนะนำครั้งถัดไป
...
### รูปแบบภาพและตัวอักษร

- Card ใช้ `border-radius: 16px`
- Input Field ใช้ `border-radius: 12px`
- ใช้ฟอนต์ภาษาไทยแบบ Sans-serif เช่น Kanit หรือ Sukhumvit Set
- จำนวนเงินใช้ตัวหนา ขนาดประมาณ `24px` เพื่อให้อ่านได้ทันที
- เมื่อระบบแนะนำหมวดหมู่จากประวัติผู้ใช้ ควรแสดงเป็นคำแนะนำที่ผู้ใช้ยืนยันหรือเปลี่ยนได้เสมอ
...
3. ผู้ใช้สามารถเพิ่ม/แก้ไขหมวดหมู่เองได้หรือไม่ และต้องการให้กฎ Auto-Categorize มีหน้าจัดการหรือไม่?
